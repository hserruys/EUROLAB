{smcl}
{right:version:  2.3.7.0}
{cmd:help asdoc} {right:March 20, 2020}
{hline}
...
{p 4 4 2} It is now almost a year in developing asdoc and constantly adding features to it. 
I think I would stop here and start working on a premium version of asdoc that would 
be more flexible in making customized tables. It will also be able to export the output 
in the following formats: Word, Excel, plain text, CSV, and LaTeX. I plan to name the premium 
version as asdocx. Updates related to asdocx can be found on {browse "https://fintechprofessor.com/stata-programs/asdocx/"} : this page}. 
