...
keep idhh idper flex* dgn* dwt hhsize numch* dag migrant mortgage lhw_f lhw_m lhw_f_norand lhw_m_norand sec_f sec_m emp_stat_f emp_stat_m les ils_* lhw ed_* lhw_choice hhtype age* bun* *_g employee selfemployed hourly_wage  hourly_MW oecd_equiv_scale 
